/*
 * JS for song100 generated by Appery.io
 */
...
function song100_js() {
    ...
    Apperyio.CurrentScreen = 'song100';
     ...
     */
    // On Load
    var song100_onLoad = function() {
        song100_elementsExtraJS();
        song100_deviceEvents();
        song100_windowEvents();
        song100_elementsEvents();
    };
    // screen window events
    function song100_windowEvents() {
        $('#song100').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song100_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song100_elementsExtraJS() {
        // screen (song100) extra code
    };
    // screen elements handler
    function song100_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song100").on("pagebeforeshow", "#song100", function(event, ui) {
        Apperyio.CurrentScreen = "song100";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song100").on("pagecreate", "#song100", function(event, ui) {
