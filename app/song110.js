/*
 * JS for song110 generated by Appery.io
 */
...
function song110_js() {
    ...
    Apperyio.CurrentScreen = 'song110';
     ...
     */
    // On Load
    var song110_onLoad = function() {
        song110_elementsExtraJS();
        song110_deviceEvents();
        song110_windowEvents();
        song110_elementsEvents();
    };
    // screen window events
    function song110_windowEvents() {
        $('#song110').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song110_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song110_elementsExtraJS() {
        // screen (song110) extra code
    };
    // screen elements handler
    function song110_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song110").on("pagebeforeshow", "#song110", function(event, ui) {
        Apperyio.CurrentScreen = "song110";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song110").on("pagecreate", "#song110", function(event, ui) {
