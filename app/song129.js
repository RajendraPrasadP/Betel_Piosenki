/*
 * JS for song129 generated by Appery.io
 */
...
function song129_js() {
    ...
    Apperyio.CurrentScreen = 'song129';
     ...
     */
    // On Load
    var song129_onLoad = function() {
        song129_elementsExtraJS();
        song129_deviceEvents();
        song129_windowEvents();
        song129_elementsEvents();
    };
    // screen window events
    function song129_windowEvents() {
        $('#song129').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song129_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song129_elementsExtraJS() {
        // screen (song129) extra code
    };
    // screen elements handler
    function song129_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song129").on("pagebeforeshow", "#song129", function(event, ui) {
        Apperyio.CurrentScreen = "song129";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song129").on("pagecreate", "#song129", function(event, ui) {
