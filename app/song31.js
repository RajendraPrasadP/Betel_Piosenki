/*
 * JS for song31 generated by Appery.io
 */
...
function song31_js() {
     ...
     */
    // On Load
    var song31_onLoad = function() {
        song31_elementsExtraJS();
        song31_deviceEvents();
        song31_windowEvents();
        song31_elementsEvents();
    };
    // screen window events
    function song31_windowEvents() {
        $('#song31').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song31_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song31_elementsExtraJS() {
        // screen (song31) extra code
    };
    // screen elements handler
    function song31_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song31").on("pagebeforeshow", "#song31", function(event, ui) {
        Apperyio.CurrentScreen = "song31";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song31").on("pagecreate", "#song31", function(event, ui) {
