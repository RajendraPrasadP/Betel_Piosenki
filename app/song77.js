/*
 * JS for song77 generated by Appery.io
 */
...
function song77_js() {
     ...
     */
    // On Load
    var song77_onLoad = function() {
        song77_elementsExtraJS();
        song77_deviceEvents();
        song77_windowEvents();
        song77_elementsEvents();
    };
    // screen window events
    function song77_windowEvents() {
        $('#song77').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song77_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song77_elementsExtraJS() {
        // screen (song77) extra code
    };
    // screen elements handler
    function song77_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song77").on("pagebeforeshow", "#song77", function(event, ui) {
        Apperyio.CurrentScreen = "song77";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song77").on("pagecreate", "#song77", function(event, ui) {
