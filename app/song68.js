/*
 * JS for song68 generated by Appery.io
 */
...
function song68_js() {
     ...
     */
    // On Load
    var song68_onLoad = function() {
        song68_elementsExtraJS();
        song68_deviceEvents();
        song68_windowEvents();
        song68_elementsEvents();
    };
    // screen window events
    function song68_windowEvents() {
        $('#song68').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song68_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song68_elementsExtraJS() {
        // screen (song68) extra code
    };
    // screen elements handler
    function song68_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song68").on("pagebeforeshow", "#song68", function(event, ui) {
        Apperyio.CurrentScreen = "song68";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song68").on("pagecreate", "#song68", function(event, ui) {
