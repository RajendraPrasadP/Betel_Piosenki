/*
 * JS for song16 generated by Appery.io
 */
...
function song16_js() {
     ...
     */
    // On Load
    var song16_onLoad = function() {
        song16_elementsExtraJS();
        song16_deviceEvents();
        song16_windowEvents();
        song16_elementsEvents();
    };
    // screen window events
    function song16_windowEvents() {
        $('#song16').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song16_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song16_elementsExtraJS() {
        // screen (song16) extra code
    };
    // screen elements handler
    function song16_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song16").on("pagebeforeshow", "#song16", function(event, ui) {
        Apperyio.CurrentScreen = "song16";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song16").on("pagecreate", "#song16", function(event, ui) {
