/*
 * JS for song61 generated by Appery.io
 */
...
function song61_js() {
     ...
     */
    // On Load
    var song61_onLoad = function() {
        song61_elementsExtraJS();
        song61_deviceEvents();
        song61_windowEvents();
        song61_elementsEvents();
    };
    // screen window events
    function song61_windowEvents() {
        $('#song61').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song61_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song61_elementsExtraJS() {
        // screen (song61) extra code
    };
    // screen elements handler
    function song61_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song61").on("pagebeforeshow", "#song61", function(event, ui) {
        Apperyio.CurrentScreen = "song61";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song61").on("pagecreate", "#song61", function(event, ui) {
