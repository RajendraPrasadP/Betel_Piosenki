/*
 * JS for song42 generated by Appery.io
 */
...
function song42_js() {
     ...
     */
    // On Load
    var song42_onLoad = function() {
        song42_elementsExtraJS();
        song42_deviceEvents();
        song42_windowEvents();
        song42_elementsEvents();
    };
    // screen window events
    function song42_windowEvents() {
        $('#song42').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song42_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song42_elementsExtraJS() {
        // screen (song42) extra code
    };
    // screen elements handler
    function song42_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song42").on("pagebeforeshow", "#song42", function(event, ui) {
        Apperyio.CurrentScreen = "song42";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song42").on("pagecreate", "#song42", function(event, ui) {
