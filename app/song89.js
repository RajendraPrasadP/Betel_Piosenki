/*
 * JS for song89 generated by Appery.io
 */
...
function song89_js() {
     ...
     */
    // On Load
    var song89_onLoad = function() {
        song89_elementsExtraJS();
        song89_deviceEvents();
        song89_windowEvents();
        song89_elementsEvents();
    };
    // screen window events
    function song89_windowEvents() {
        $('#song89').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song89_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song89_elementsExtraJS() {
        // screen (song89) extra code
    };
    // screen elements handler
    function song89_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song89").on("pagebeforeshow", "#song89", function(event, ui) {
        Apperyio.CurrentScreen = "song89";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song89").on("pagecreate", "#song89", function(event, ui) {
