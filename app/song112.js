/*
 * JS for song112 generated by Appery.io
 */
...
function song112_js() {
    ...
    Apperyio.CurrentScreen = 'song112';
     ...
     */
    // On Load
    var song112_onLoad = function() {
        song112_elementsExtraJS();
        song112_deviceEvents();
        song112_windowEvents();
        song112_elementsEvents();
    };
    // screen window events
    function song112_windowEvents() {
        $('#song112').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song112_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song112_elementsExtraJS() {
        // screen (song112) extra code
    };
    // screen elements handler
    function song112_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song112").on("pagebeforeshow", "#song112", function(event, ui) {
        Apperyio.CurrentScreen = "song112";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song112").on("pagecreate", "#song112", function(event, ui) {
