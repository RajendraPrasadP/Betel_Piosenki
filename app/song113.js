/*
 * JS for song113 generated by Appery.io
 */
...
function song113_js() {
    ...
    Apperyio.CurrentScreen = 'song113';
     ...
     */
    // On Load
    var song113_onLoad = function() {
        song113_elementsExtraJS();
        song113_deviceEvents();
        song113_windowEvents();
        song113_elementsEvents();
    };
    // screen window events
    function song113_windowEvents() {
        $('#song113').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song113_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song113_elementsExtraJS() {
        // screen (song113) extra code
    };
    // screen elements handler
    function song113_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song113").on("pagebeforeshow", "#song113", function(event, ui) {
        Apperyio.CurrentScreen = "song113";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song113").on("pagecreate", "#song113", function(event, ui) {
