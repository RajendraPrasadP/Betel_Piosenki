/*
 * JS for song106 generated by Appery.io
 */
...
function song106_js() {
    ...
    Apperyio.CurrentScreen = 'song106';
     ...
     */
    // On Load
    var song106_onLoad = function() {
        song106_elementsExtraJS();
        song106_deviceEvents();
        song106_windowEvents();
        song106_elementsEvents();
    };
    // screen window events
    function song106_windowEvents() {
        $('#song106').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song106_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song106_elementsExtraJS() {
        // screen (song106) extra code
    };
    // screen elements handler
    function song106_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song106").on("pagebeforeshow", "#song106", function(event, ui) {
        Apperyio.CurrentScreen = "song106";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song106").on("pagecreate", "#song106", function(event, ui) {
