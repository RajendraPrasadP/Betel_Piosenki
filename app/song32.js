/*
 * JS for song32 generated by Appery.io
 */
...
function song32_js() {
     ...
     */
    // On Load
    var song32_onLoad = function() {
        song32_elementsExtraJS();
        song32_deviceEvents();
        song32_windowEvents();
        song32_elementsEvents();
    };
    // screen window events
    function song32_windowEvents() {
        $('#song32').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song32_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song32_elementsExtraJS() {
        // screen (song32) extra code
    };
    // screen elements handler
    function song32_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song32").on("pagebeforeshow", "#song32", function(event, ui) {
        Apperyio.CurrentScreen = "song32";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song32").on("pagecreate", "#song32", function(event, ui) {
