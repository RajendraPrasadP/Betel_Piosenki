/*
 * JS for song66 generated by Appery.io
 */
...
function song66_js() {
     ...
     */
    // On Load
    var song66_onLoad = function() {
        song66_elementsExtraJS();
        song66_deviceEvents();
        song66_windowEvents();
        song66_elementsEvents();
    };
    // screen window events
    function song66_windowEvents() {
        $('#song66').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song66_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song66_elementsExtraJS() {
        // screen (song66) extra code
    };
    // screen elements handler
    function song66_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song66").on("pagebeforeshow", "#song66", function(event, ui) {
        Apperyio.CurrentScreen = "song66";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song66").on("pagecreate", "#song66", function(event, ui) {
