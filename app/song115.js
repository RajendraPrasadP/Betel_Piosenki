/*
 * JS for song115 generated by Appery.io
 */
...
function song115_js() {
    ...
    Apperyio.CurrentScreen = 'song115';
     ...
     */
    // On Load
    var song115_onLoad = function() {
        song115_elementsExtraJS();
        song115_deviceEvents();
        song115_windowEvents();
        song115_elementsEvents();
    };
    // screen window events
    function song115_windowEvents() {
        $('#song115').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song115_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song115_elementsExtraJS() {
        // screen (song115) extra code
    };
    // screen elements handler
    function song115_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song115").on("pagebeforeshow", "#song115", function(event, ui) {
        Apperyio.CurrentScreen = "song115";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song115").on("pagecreate", "#song115", function(event, ui) {
