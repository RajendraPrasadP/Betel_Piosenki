/*
 * JS for song76 generated by Appery.io
 */
...
function song76_js() {
     ...
     */
    // On Load
    var song76_onLoad = function() {
        song76_elementsExtraJS();
        song76_deviceEvents();
        song76_windowEvents();
        song76_elementsEvents();
    };
    // screen window events
    function song76_windowEvents() {
        $('#song76').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song76_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song76_elementsExtraJS() {
        // screen (song76) extra code
    };
    // screen elements handler
    function song76_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song76").on("pagebeforeshow", "#song76", function(event, ui) {
        Apperyio.CurrentScreen = "song76";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song76").on("pagecreate", "#song76", function(event, ui) {
