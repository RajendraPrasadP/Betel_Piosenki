/*
 * JS for song126 generated by Appery.io
 */
...
function song126_js() {
    ...
    Apperyio.CurrentScreen = 'song126';
     ...
     */
    // On Load
    var song126_onLoad = function() {
        song126_elementsExtraJS();
        song126_deviceEvents();
        song126_windowEvents();
        song126_elementsEvents();
    };
    // screen window events
    function song126_windowEvents() {
        $('#song126').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song126_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song126_elementsExtraJS() {
        // screen (song126) extra code
    };
    // screen elements handler
    function song126_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song126").on("pagebeforeshow", "#song126", function(event, ui) {
        Apperyio.CurrentScreen = "song126";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song126").on("pagecreate", "#song126", function(event, ui) {
