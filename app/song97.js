/*
 * JS for song97 generated by Appery.io
 */
...
function song97_js() {
     ...
     */
    // On Load
    var song97_onLoad = function() {
        song97_elementsExtraJS();
        song97_deviceEvents();
        song97_windowEvents();
        song97_elementsEvents();
    };
    // screen window events
    function song97_windowEvents() {
        $('#song97').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song97_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song97_elementsExtraJS() {
        // screen (song97) extra code
    };
    // screen elements handler
    function song97_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song97").on("pagebeforeshow", "#song97", function(event, ui) {
        Apperyio.CurrentScreen = "song97";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song97").on("pagecreate", "#song97", function(event, ui) {
