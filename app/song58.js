/*
 * JS for song58 generated by Appery.io
 */
...
function song58_js() {
     ...
     */
    // On Load
    var song58_onLoad = function() {
        song58_elementsExtraJS();
        song58_deviceEvents();
        song58_windowEvents();
        song58_elementsEvents();
    };
    // screen window events
    function song58_windowEvents() {
        $('#song58').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song58_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song58_elementsExtraJS() {
        // screen (song58) extra code
    };
    // screen elements handler
    function song58_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song58").on("pagebeforeshow", "#song58", function(event, ui) {
        Apperyio.CurrentScreen = "song58";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song58").on("pagecreate", "#song58", function(event, ui) {
