/*
 * JS for song27 generated by Appery.io
 */
...
function song27_js() {
     ...
     */
    // On Load
    var song27_onLoad = function() {
        song27_elementsExtraJS();
        song27_deviceEvents();
        song27_windowEvents();
        song27_elementsEvents();
    };
    // screen window events
    function song27_windowEvents() {
        $('#song27').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song27_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song27_elementsExtraJS() {
        // screen (song27) extra code
    };
    // screen elements handler
    function song27_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song27").on("pagebeforeshow", "#song27", function(event, ui) {
        Apperyio.CurrentScreen = "song27";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song27").on("pagecreate", "#song27", function(event, ui) {
