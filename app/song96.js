/*
 * JS for song96 generated by Appery.io
 */
...
function song96_js() {
     ...
     */
    // On Load
    var song96_onLoad = function() {
        song96_elementsExtraJS();
        song96_deviceEvents();
        song96_windowEvents();
        song96_elementsEvents();
    };
    // screen window events
    function song96_windowEvents() {
        $('#song96').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song96_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song96_elementsExtraJS() {
        // screen (song96) extra code
    };
    // screen elements handler
    function song96_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song96").on("pagebeforeshow", "#song96", function(event, ui) {
        Apperyio.CurrentScreen = "song96";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song96").on("pagecreate", "#song96", function(event, ui) {
