/*
 * JS for song72 generated by Appery.io
 */
...
function song72_js() {
     ...
     */
    // On Load
    var song72_onLoad = function() {
        song72_elementsExtraJS();
        song72_deviceEvents();
        song72_windowEvents();
        song72_elementsEvents();
    };
    // screen window events
    function song72_windowEvents() {
        $('#song72').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song72_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song72_elementsExtraJS() {
        // screen (song72) extra code
    };
    // screen elements handler
    function song72_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song72").on("pagebeforeshow", "#song72", function(event, ui) {
        Apperyio.CurrentScreen = "song72";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song72").on("pagecreate", "#song72", function(event, ui) {
