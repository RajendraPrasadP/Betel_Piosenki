/*
 * JS for song43 generated by Appery.io
 */
...
function song43_js() {
     ...
     */
    // On Load
    var song43_onLoad = function() {
        song43_elementsExtraJS();
        song43_deviceEvents();
        song43_windowEvents();
        song43_elementsEvents();
    };
    // screen window events
    function song43_windowEvents() {
        $('#song43').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song43_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song43_elementsExtraJS() {
        // screen (song43) extra code
    };
    // screen elements handler
    function song43_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song43").on("pagebeforeshow", "#song43", function(event, ui) {
        Apperyio.CurrentScreen = "song43";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song43").on("pagecreate", "#song43", function(event, ui) {
