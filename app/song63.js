/*
 * JS for song63 generated by Appery.io
 */
...
function song63_js() {
     ...
     */
    // On Load
    var song63_onLoad = function() {
        song63_elementsExtraJS();
        song63_deviceEvents();
        song63_windowEvents();
        song63_elementsEvents();
    };
    // screen window events
    function song63_windowEvents() {
        $('#song63').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song63_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song63_elementsExtraJS() {
        // screen (song63) extra code
    };
    // screen elements handler
    function song63_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song63").on("pagebeforeshow", "#song63", function(event, ui) {
        Apperyio.CurrentScreen = "song63";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song63").on("pagecreate", "#song63", function(event, ui) {
