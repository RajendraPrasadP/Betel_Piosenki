/*
 * JS for song109 generated by Appery.io
 */
...
function song109_js() {
    ...
    Apperyio.CurrentScreen = 'song109';
     ...
     */
    // On Load
    var song109_onLoad = function() {
        song109_elementsExtraJS();
        song109_deviceEvents();
        song109_windowEvents();
        song109_elementsEvents();
    };
    // screen window events
    function song109_windowEvents() {
        $('#song109').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song109_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song109_elementsExtraJS() {
        // screen (song109) extra code
    };
    // screen elements handler
    function song109_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song109").on("pagebeforeshow", "#song109", function(event, ui) {
        Apperyio.CurrentScreen = "song109";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song109").on("pagecreate", "#song109", function(event, ui) {
