/*
 * JS for song119 generated by Appery.io
 */
...
function song119_js() {
    ...
    Apperyio.CurrentScreen = 'song119';
     ...
     */
    // On Load
    var song119_onLoad = function() {
        song119_elementsExtraJS();
        song119_deviceEvents();
        song119_windowEvents();
        song119_elementsEvents();
    };
    // screen window events
    function song119_windowEvents() {
        $('#song119').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song119_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song119_elementsExtraJS() {
        // screen (song119) extra code
    };
    // screen elements handler
    function song119_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song119").on("pagebeforeshow", "#song119", function(event, ui) {
        Apperyio.CurrentScreen = "song119";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song119").on("pagecreate", "#song119", function(event, ui) {
