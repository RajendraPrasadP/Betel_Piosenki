/*
 * JS for song71 generated by Appery.io
 */
...
function song71_js() {
     ...
     */
    // On Load
    var song71_onLoad = function() {
        song71_elementsExtraJS();
        song71_deviceEvents();
        song71_windowEvents();
        song71_elementsEvents();
    };
    // screen window events
    function song71_windowEvents() {
        $('#song71').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song71_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song71_elementsExtraJS() {
        // screen (song71) extra code
    };
    // screen elements handler
    function song71_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song71").on("pagebeforeshow", "#song71", function(event, ui) {
        Apperyio.CurrentScreen = "song71";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song71").on("pagecreate", "#song71", function(event, ui) {
