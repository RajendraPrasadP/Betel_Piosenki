/*
 * JS for song36 generated by Appery.io
 */
...
function song36_js() {
     ...
     */
    // On Load
    var song36_onLoad = function() {
        song36_elementsExtraJS();
        song36_deviceEvents();
        song36_windowEvents();
        song36_elementsEvents();
    };
    // screen window events
    function song36_windowEvents() {
        $('#song36').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song36_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song36_elementsExtraJS() {
        // screen (song36) extra code
    };
    // screen elements handler
    function song36_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song36").on("pagebeforeshow", "#song36", function(event, ui) {
        Apperyio.CurrentScreen = "song36";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song36").on("pagecreate", "#song36", function(event, ui) {
