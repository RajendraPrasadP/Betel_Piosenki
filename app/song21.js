/*
 * JS for song21 generated by Appery.io
 */
...
function song21_js() {
     ...
     */
    // On Load
    var song21_onLoad = function() {
        song21_elementsExtraJS();
        song21_deviceEvents();
        song21_windowEvents();
        song21_elementsEvents();
    };
    // screen window events
    function song21_windowEvents() {
        $('#song21').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song21_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song21_elementsExtraJS() {
        // screen (song21) extra code
    };
    // screen elements handler
    function song21_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song21").on("pagebeforeshow", "#song21", function(event, ui) {
        Apperyio.CurrentScreen = "song21";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song21").on("pagecreate", "#song21", function(event, ui) {
