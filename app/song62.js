/*
 * JS for song62 generated by Appery.io
 */
...
function song62_js() {
     ...
     */
    // On Load
    var song62_onLoad = function() {
        song62_elementsExtraJS();
        song62_deviceEvents();
        song62_windowEvents();
        song62_elementsEvents();
    };
    // screen window events
    function song62_windowEvents() {
        $('#song62').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song62_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song62_elementsExtraJS() {
        // screen (song62) extra code
    };
    // screen elements handler
    function song62_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song62").on("pagebeforeshow", "#song62", function(event, ui) {
        Apperyio.CurrentScreen = "song62";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song62").on("pagecreate", "#song62", function(event, ui) {
