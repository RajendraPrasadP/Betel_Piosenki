/*
 * JS for song74 generated by Appery.io
 */
...
function song74_js() {
     ...
     */
    // On Load
    var song74_onLoad = function() {
        song74_elementsExtraJS();
        song74_deviceEvents();
        song74_windowEvents();
        song74_elementsEvents();
    };
    // screen window events
    function song74_windowEvents() {
        $('#song74').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song74_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song74_elementsExtraJS() {
        // screen (song74) extra code
    };
    // screen elements handler
    function song74_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song74").on("pagebeforeshow", "#song74", function(event, ui) {
        Apperyio.CurrentScreen = "song74";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song74").on("pagecreate", "#song74", function(event, ui) {
