/*
 * JS for song46 generated by Appery.io
 */
...
function song46_js() {
     ...
     */
    // On Load
    var song46_onLoad = function() {
        song46_elementsExtraJS();
        song46_deviceEvents();
        song46_windowEvents();
        song46_elementsEvents();
    };
    // screen window events
    function song46_windowEvents() {
        $('#song46').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song46_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song46_elementsExtraJS() {
        // screen (song46) extra code
    };
    // screen elements handler
    function song46_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song46").on("pagebeforeshow", "#song46", function(event, ui) {
        Apperyio.CurrentScreen = "song46";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song46").on("pagecreate", "#song46", function(event, ui) {
