/*
 * JS for song111 generated by Appery.io
 */
...
function song111_js() {
    ...
    Apperyio.CurrentScreen = 'song111';
     ...
     */
    // On Load
    var song111_onLoad = function() {
        song111_elementsExtraJS();
        song111_deviceEvents();
        song111_windowEvents();
        song111_elementsEvents();
    };
    // screen window events
    function song111_windowEvents() {
        $('#song111').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song111_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song111_elementsExtraJS() {
        // screen (song111) extra code
    };
    // screen elements handler
    function song111_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song111").on("pagebeforeshow", "#song111", function(event, ui) {
        Apperyio.CurrentScreen = "song111";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song111").on("pagecreate", "#song111", function(event, ui) {
