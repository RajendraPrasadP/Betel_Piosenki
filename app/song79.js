/*
 * JS for song79 generated by Appery.io
 */
...
function song79_js() {
     ...
     */
    // On Load
    var song79_onLoad = function() {
        song79_elementsExtraJS();
        song79_deviceEvents();
        song79_windowEvents();
        song79_elementsEvents();
    };
    // screen window events
    function song79_windowEvents() {
        $('#song79').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song79_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song79_elementsExtraJS() {
        // screen (song79) extra code
    };
    // screen elements handler
    function song79_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song79").on("pagebeforeshow", "#song79", function(event, ui) {
        Apperyio.CurrentScreen = "song79";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song79").on("pagecreate", "#song79", function(event, ui) {
