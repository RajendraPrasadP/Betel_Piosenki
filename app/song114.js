/*
 * JS for song114 generated by Appery.io
 */
...
function song114_js() {
    ...
    Apperyio.CurrentScreen = 'song114';
     ...
     */
    // On Load
    var song114_onLoad = function() {
        song114_elementsExtraJS();
        song114_deviceEvents();
        song114_windowEvents();
        song114_elementsEvents();
    };
    // screen window events
    function song114_windowEvents() {
        $('#song114').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song114_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song114_elementsExtraJS() {
        // screen (song114) extra code
    };
    // screen elements handler
    function song114_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song114").on("pagebeforeshow", "#song114", function(event, ui) {
        Apperyio.CurrentScreen = "song114";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song114").on("pagecreate", "#song114", function(event, ui) {
