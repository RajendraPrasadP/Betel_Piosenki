/*
 * JS for song39 generated by Appery.io
 */
...
function song39_js() {
     ...
     */
    // On Load
    var song39_onLoad = function() {
        song39_elementsExtraJS();
        song39_deviceEvents();
        song39_windowEvents();
        song39_elementsEvents();
    };
    // screen window events
    function song39_windowEvents() {
        $('#song39').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song39_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song39_elementsExtraJS() {
        // screen (song39) extra code
    };
    // screen elements handler
    function song39_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song39").on("pagebeforeshow", "#song39", function(event, ui) {
        Apperyio.CurrentScreen = "song39";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song39").on("pagecreate", "#song39", function(event, ui) {
