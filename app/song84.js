/*
 * JS for song84 generated by Appery.io
 */
...
function song84_js() {
     ...
     */
    // On Load
    var song84_onLoad = function() {
        song84_elementsExtraJS();
        song84_deviceEvents();
        song84_windowEvents();
        song84_elementsEvents();
    };
    // screen window events
    function song84_windowEvents() {
        $('#song84').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song84_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song84_elementsExtraJS() {
        // screen (song84) extra code
    };
    // screen elements handler
    function song84_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song84").on("pagebeforeshow", "#song84", function(event, ui) {
        Apperyio.CurrentScreen = "song84";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song84").on("pagecreate", "#song84", function(event, ui) {
