/*
 * JS for song81 generated by Appery.io
 */
...
function song81_js() {
     ...
     */
    // On Load
    var song81_onLoad = function() {
        song81_elementsExtraJS();
        song81_deviceEvents();
        song81_windowEvents();
        song81_elementsEvents();
    };
    // screen window events
    function song81_windowEvents() {
        $('#song81').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song81_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song81_elementsExtraJS() {
        // screen (song81) extra code
    };
    // screen elements handler
    function song81_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song81").on("pagebeforeshow", "#song81", function(event, ui) {
        Apperyio.CurrentScreen = "song81";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song81").on("pagecreate", "#song81", function(event, ui) {
