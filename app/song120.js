/*
 * JS for song120 generated by Appery.io
 */
...
function song120_js() {
    ...
    Apperyio.CurrentScreen = 'song120';
     ...
     */
    // On Load
    var song120_onLoad = function() {
        song120_elementsExtraJS();
        song120_deviceEvents();
        song120_windowEvents();
        song120_elementsEvents();
    };
    // screen window events
    function song120_windowEvents() {
        $('#song120').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song120_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song120_elementsExtraJS() {
        // screen (song120) extra code
    };
    // screen elements handler
    function song120_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song120").on("pagebeforeshow", "#song120", function(event, ui) {
        Apperyio.CurrentScreen = "song120";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song120").on("pagecreate", "#song120", function(event, ui) {
