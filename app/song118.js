/*
 * JS for song118 generated by Appery.io
 */
...
function song118_js() {
    ...
    Apperyio.CurrentScreen = 'song118';
     ...
     */
    // On Load
    var song118_onLoad = function() {
        song118_elementsExtraJS();
        song118_deviceEvents();
        song118_windowEvents();
        song118_elementsEvents();
    };
    // screen window events
    function song118_windowEvents() {
        $('#song118').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song118_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song118_elementsExtraJS() {
        // screen (song118) extra code
    };
    // screen elements handler
    function song118_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song118").on("pagebeforeshow", "#song118", function(event, ui) {
        Apperyio.CurrentScreen = "song118";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song118").on("pagecreate", "#song118", function(event, ui) {
