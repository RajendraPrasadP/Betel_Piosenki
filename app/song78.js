/*
 * JS for song78 generated by Appery.io
 */
...
function song78_js() {
     ...
     */
    // On Load
    var song78_onLoad = function() {
        song78_elementsExtraJS();
        song78_deviceEvents();
        song78_windowEvents();
        song78_elementsEvents();
    };
    // screen window events
    function song78_windowEvents() {
        $('#song78').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song78_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song78_elementsExtraJS() {
        // screen (song78) extra code
    };
    // screen elements handler
    function song78_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song78").on("pagebeforeshow", "#song78", function(event, ui) {
        Apperyio.CurrentScreen = "song78";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song78").on("pagecreate", "#song78", function(event, ui) {
