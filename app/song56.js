/*
 * JS for song56 generated by Appery.io
 */
...
function song56_js() {
     ...
     */
    // On Load
    var song56_onLoad = function() {
        song56_elementsExtraJS();
        song56_deviceEvents();
        song56_windowEvents();
        song56_elementsEvents();
    };
    // screen window events
    function song56_windowEvents() {
        $('#song56').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song56_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song56_elementsExtraJS() {
        // screen (song56) extra code
    };
    // screen elements handler
    function song56_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song56").on("pagebeforeshow", "#song56", function(event, ui) {
        Apperyio.CurrentScreen = "song56";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song56").on("pagecreate", "#song56", function(event, ui) {
