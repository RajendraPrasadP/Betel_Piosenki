/*
 * JS for song131 generated by Appery.io
 */
...
function song131_js() {
    ...
    Apperyio.CurrentScreen = 'song131';
     ...
     */
    // On Load
    var song131_onLoad = function() {
        song131_elementsExtraJS();
        song131_deviceEvents();
        song131_windowEvents();
        song131_elementsEvents();
    };
    // screen window events
    function song131_windowEvents() {
        $('#song131').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song131_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song131_elementsExtraJS() {
        // screen (song131) extra code
    };
    // screen elements handler
    function song131_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song131").on("pagebeforeshow", "#song131", function(event, ui) {
        Apperyio.CurrentScreen = "song131";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song131").on("pagecreate", "#song131", function(event, ui) {
