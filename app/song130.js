/*
 * JS for song130 generated by Appery.io
 */
...
function song130_js() {
    ...
    Apperyio.CurrentScreen = 'song130';
     ...
     */
    // On Load
    var song130_onLoad = function() {
        song130_elementsExtraJS();
        song130_deviceEvents();
        song130_windowEvents();
        song130_elementsEvents();
    };
    // screen window events
    function song130_windowEvents() {
        $('#song130').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song130_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song130_elementsExtraJS() {
        // screen (song130) extra code
    };
    // screen elements handler
    function song130_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song130").on("pagebeforeshow", "#song130", function(event, ui) {
        Apperyio.CurrentScreen = "song130";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song130").on("pagecreate", "#song130", function(event, ui) {
