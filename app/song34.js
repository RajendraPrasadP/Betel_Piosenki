/*
 * JS for song34 generated by Appery.io
 */
...
function song34_js() {
     ...
     */
    // On Load
    var song34_onLoad = function() {
        song34_elementsExtraJS();
        song34_deviceEvents();
        song34_windowEvents();
        song34_elementsEvents();
    };
    // screen window events
    function song34_windowEvents() {
        $('#song34').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song34_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song34_elementsExtraJS() {
        // screen (song34) extra code
    };
    // screen elements handler
    function song34_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song34").on("pagebeforeshow", "#song34", function(event, ui) {
        Apperyio.CurrentScreen = "song34";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song34").on("pagecreate", "#song34", function(event, ui) {
