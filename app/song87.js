/*
 * JS for song87 generated by Appery.io
 */
...
function song87_js() {
     ...
     */
    // On Load
    var song87_onLoad = function() {
        song87_elementsExtraJS();
        song87_deviceEvents();
        song87_windowEvents();
        song87_elementsEvents();
    };
    // screen window events
    function song87_windowEvents() {
        $('#song87').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song87_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song87_elementsExtraJS() {
        // screen (song87) extra code
    };
    // screen elements handler
    function song87_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song87").on("pagebeforeshow", "#song87", function(event, ui) {
        Apperyio.CurrentScreen = "song87";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song87").on("pagecreate", "#song87", function(event, ui) {
