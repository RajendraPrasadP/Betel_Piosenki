/*
 * JS for song53 generated by Appery.io
 */
...
function song53_js() {
     ...
     */
    // On Load
    var song53_onLoad = function() {
        song53_elementsExtraJS();
        song53_deviceEvents();
        song53_windowEvents();
        song53_elementsEvents();
    };
    // screen window events
    function song53_windowEvents() {
        $('#song53').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song53_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song53_elementsExtraJS() {
        // screen (song53) extra code
    };
    // screen elements handler
    function song53_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song53").on("pagebeforeshow", "#song53", function(event, ui) {
        Apperyio.CurrentScreen = "song53";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song53").on("pagecreate", "#song53", function(event, ui) {
