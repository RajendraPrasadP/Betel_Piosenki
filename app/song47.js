/*
 * JS for song47 generated by Appery.io
 */
...
function song47_js() {
     ...
     */
    // On Load
    var song47_onLoad = function() {
        song47_elementsExtraJS();
        song47_deviceEvents();
        song47_windowEvents();
        song47_elementsEvents();
    };
    // screen window events
    function song47_windowEvents() {
        $('#song47').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song47_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song47_elementsExtraJS() {
        // screen (song47) extra code
    };
    // screen elements handler
    function song47_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song47").on("pagebeforeshow", "#song47", function(event, ui) {
        Apperyio.CurrentScreen = "song47";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song47").on("pagecreate", "#song47", function(event, ui) {
