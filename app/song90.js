/*
 * JS for song90 generated by Appery.io
 */
...
function song90_js() {
     ...
     */
    // On Load
    var song90_onLoad = function() {
        song90_elementsExtraJS();
        song90_deviceEvents();
        song90_windowEvents();
        song90_elementsEvents();
    };
    // screen window events
    function song90_windowEvents() {
        $('#song90').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song90_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song90_elementsExtraJS() {
        // screen (song90) extra code
    };
    // screen elements handler
    function song90_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song90").on("pagebeforeshow", "#song90", function(event, ui) {
        Apperyio.CurrentScreen = "song90";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song90").on("pagecreate", "#song90", function(event, ui) {
