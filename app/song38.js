/*
 * JS for song38 generated by Appery.io
 */
...
function song38_js() {
     ...
     */
    // On Load
    var song38_onLoad = function() {
        song38_elementsExtraJS();
        song38_deviceEvents();
        song38_windowEvents();
        song38_elementsEvents();
    };
    // screen window events
    function song38_windowEvents() {
        $('#song38').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song38_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song38_elementsExtraJS() {
        // screen (song38) extra code
    };
    // screen elements handler
    function song38_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song38").on("pagebeforeshow", "#song38", function(event, ui) {
        Apperyio.CurrentScreen = "song38";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song38").on("pagecreate", "#song38", function(event, ui) {
