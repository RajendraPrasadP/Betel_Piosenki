/*
 * JS for song108 generated by Appery.io
 */
...
function song108_js() {
    ...
    Apperyio.CurrentScreen = 'song108';
     ...
     */
    // On Load
    var song108_onLoad = function() {
        song108_elementsExtraJS();
        song108_deviceEvents();
        song108_windowEvents();
        song108_elementsEvents();
    };
    // screen window events
    function song108_windowEvents() {
        $('#song108').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song108_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song108_elementsExtraJS() {
        // screen (song108) extra code
    };
    // screen elements handler
    function song108_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song108").on("pagebeforeshow", "#song108", function(event, ui) {
        Apperyio.CurrentScreen = "song108";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song108").on("pagecreate", "#song108", function(event, ui) {
