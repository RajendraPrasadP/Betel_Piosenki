/*
 * JS for song29 generated by Appery.io
 */
...
function song29_js() {
     ...
     */
    // On Load
    var song29_onLoad = function() {
        song29_elementsExtraJS();
        song29_deviceEvents();
        song29_windowEvents();
        song29_elementsEvents();
    };
    // screen window events
    function song29_windowEvents() {
        $('#song29').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song29_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song29_elementsExtraJS() {
        // screen (song29) extra code
    };
    // screen elements handler
    function song29_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song29").on("pagebeforeshow", "#song29", function(event, ui) {
        Apperyio.CurrentScreen = "song29";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song29").on("pagecreate", "#song29", function(event, ui) {
