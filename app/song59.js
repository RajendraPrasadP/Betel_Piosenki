/*
 * JS for song59 generated by Appery.io
 */
...
function song59_js() {
     ...
     */
    // On Load
    var song59_onLoad = function() {
        song59_elementsExtraJS();
        song59_deviceEvents();
        song59_windowEvents();
        song59_elementsEvents();
    };
    // screen window events
    function song59_windowEvents() {
        $('#song59').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song59_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song59_elementsExtraJS() {
        // screen (song59) extra code
    };
    // screen elements handler
    function song59_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song59").on("pagebeforeshow", "#song59", function(event, ui) {
        Apperyio.CurrentScreen = "song59";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song59").on("pagecreate", "#song59", function(event, ui) {
