/*
 * JS for song30 generated by Appery.io
 */
...
function song30_js() {
     ...
     */
    // On Load
    var song30_onLoad = function() {
        song30_elementsExtraJS();
        song30_deviceEvents();
        song30_windowEvents();
        song30_elementsEvents();
    };
    // screen window events
    function song30_windowEvents() {
        $('#song30').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song30_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song30_elementsExtraJS() {
        // screen (song30) extra code
    };
    // screen elements handler
    function song30_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song30").on("pagebeforeshow", "#song30", function(event, ui) {
        Apperyio.CurrentScreen = "song30";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song30").on("pagecreate", "#song30", function(event, ui) {
