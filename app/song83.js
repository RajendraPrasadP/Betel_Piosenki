/*
 * JS for song83 generated by Appery.io
 */
...
function song83_js() {
     ...
     */
    // On Load
    var song83_onLoad = function() {
        song83_elementsExtraJS();
        song83_deviceEvents();
        song83_windowEvents();
        song83_elementsEvents();
    };
    // screen window events
    function song83_windowEvents() {
        $('#song83').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song83_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song83_elementsExtraJS() {
        // screen (song83) extra code
    };
    // screen elements handler
    function song83_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song83").on("pagebeforeshow", "#song83", function(event, ui) {
        Apperyio.CurrentScreen = "song83";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song83").on("pagecreate", "#song83", function(event, ui) {
