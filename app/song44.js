/*
 * JS for song44 generated by Appery.io
 */
...
function song44_js() {
     ...
     */
    // On Load
    var song44_onLoad = function() {
        song44_elementsExtraJS();
        song44_deviceEvents();
        song44_windowEvents();
        song44_elementsEvents();
    };
    // screen window events
    function song44_windowEvents() {
        $('#song44').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song44_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song44_elementsExtraJS() {
        // screen (song44) extra code
    };
    // screen elements handler
    function song44_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song44").on("pagebeforeshow", "#song44", function(event, ui) {
        Apperyio.CurrentScreen = "song44";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song44").on("pagecreate", "#song44", function(event, ui) {
