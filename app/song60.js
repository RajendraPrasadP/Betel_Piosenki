/*
 * JS for song60 generated by Appery.io
 */
...
function song60_js() {
     ...
     */
    // On Load
    var song60_onLoad = function() {
        song60_elementsExtraJS();
        song60_deviceEvents();
        song60_windowEvents();
        song60_elementsEvents();
    };
    // screen window events
    function song60_windowEvents() {
        $('#song60').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song60_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song60_elementsExtraJS() {
        // screen (song60) extra code
    };
    // screen elements handler
    function song60_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song60").on("pagebeforeshow", "#song60", function(event, ui) {
        Apperyio.CurrentScreen = "song60";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song60").on("pagecreate", "#song60", function(event, ui) {
