/*
 * JS for song24 generated by Appery.io
 */
...
function song24_js() {
     ...
     */
    // On Load
    var song24_onLoad = function() {
        song24_elementsExtraJS();
        song24_deviceEvents();
        song24_windowEvents();
        song24_elementsEvents();
    };
    // screen window events
    function song24_windowEvents() {
        $('#song24').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song24_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song24_elementsExtraJS() {
        // screen (song24) extra code
    };
    // screen elements handler
    function song24_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song24").on("pagebeforeshow", "#song24", function(event, ui) {
        Apperyio.CurrentScreen = "song24";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song24").on("pagecreate", "#song24", function(event, ui) {
