/*
 * JS for song86 generated by Appery.io
 */
...
function song86_js() {
     ...
     */
    // On Load
    var song86_onLoad = function() {
        song86_elementsExtraJS();
        song86_deviceEvents();
        song86_windowEvents();
        song86_elementsEvents();
    };
    // screen window events
    function song86_windowEvents() {
        $('#song86').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song86_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song86_elementsExtraJS() {
        // screen (song86) extra code
    };
    // screen elements handler
    function song86_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song86").on("pagebeforeshow", "#song86", function(event, ui) {
        Apperyio.CurrentScreen = "song86";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song86").on("pagecreate", "#song86", function(event, ui) {
