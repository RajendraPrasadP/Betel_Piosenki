/*
 * JS for song54 generated by Appery.io
 */
...
function song54_js() {
     ...
     */
    // On Load
    var song54_onLoad = function() {
        song54_elementsExtraJS();
        song54_deviceEvents();
        song54_windowEvents();
        song54_elementsEvents();
    };
    // screen window events
    function song54_windowEvents() {
        $('#song54').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song54_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song54_elementsExtraJS() {
        // screen (song54) extra code
    };
    // screen elements handler
    function song54_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song54").on("pagebeforeshow", "#song54", function(event, ui) {
        Apperyio.CurrentScreen = "song54";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song54").on("pagecreate", "#song54", function(event, ui) {
