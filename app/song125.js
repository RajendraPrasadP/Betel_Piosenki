/*
 * JS for song125 generated by Appery.io
 */
...
function song125_js() {
    ...
    Apperyio.CurrentScreen = 'song125';
     ...
     */
    // On Load
    var song125_onLoad = function() {
        song125_elementsExtraJS();
        song125_deviceEvents();
        song125_windowEvents();
        song125_elementsEvents();
    };
    // screen window events
    function song125_windowEvents() {
        $('#song125').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song125_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song125_elementsExtraJS() {
        // screen (song125) extra code
    };
    // screen elements handler
    function song125_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song125").on("pagebeforeshow", "#song125", function(event, ui) {
        Apperyio.CurrentScreen = "song125";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song125").on("pagecreate", "#song125", function(event, ui) {
