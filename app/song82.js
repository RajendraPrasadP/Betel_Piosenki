/*
 * JS for song82 generated by Appery.io
 */
...
function song82_js() {
     ...
     */
    // On Load
    var song82_onLoad = function() {
        song82_elementsExtraJS();
        song82_deviceEvents();
        song82_windowEvents();
        song82_elementsEvents();
    };
    // screen window events
    function song82_windowEvents() {
        $('#song82').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song82_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song82_elementsExtraJS() {
        // screen (song82) extra code
    };
    // screen elements handler
    function song82_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song82").on("pagebeforeshow", "#song82", function(event, ui) {
        Apperyio.CurrentScreen = "song82";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song82").on("pagecreate", "#song82", function(event, ui) {
