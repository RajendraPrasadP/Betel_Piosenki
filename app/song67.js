/*
 * JS for song67 generated by Appery.io
 */
...
function song67_js() {
     ...
     */
    // On Load
    var song67_onLoad = function() {
        song67_elementsExtraJS();
        song67_deviceEvents();
        song67_windowEvents();
        song67_elementsEvents();
    };
    // screen window events
    function song67_windowEvents() {
        $('#song67').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song67_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song67_elementsExtraJS() {
        // screen (song67) extra code
    };
    // screen elements handler
    function song67_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song67").on("pagebeforeshow", "#song67", function(event, ui) {
        Apperyio.CurrentScreen = "song67";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song67").on("pagecreate", "#song67", function(event, ui) {
