/*
 * JS for song134 generated by Appery.io
 */
...
function song134_js() {
    ...
    Apperyio.CurrentScreen = 'song134';
     ...
     */
    // On Load
    var song134_onLoad = function() {
        song134_elementsExtraJS();
        song134_deviceEvents();
        song134_windowEvents();
        song134_elementsEvents();
    };
    // screen window events
    function song134_windowEvents() {
        $('#song134').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song134_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song134_elementsExtraJS() {
        // screen (song134) extra code
    };
    // screen elements handler
    function song134_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song134").on("pagebeforeshow", "#song134", function(event, ui) {
        Apperyio.CurrentScreen = "song134";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song134").on("pagecreate", "#song134", function(event, ui) {
