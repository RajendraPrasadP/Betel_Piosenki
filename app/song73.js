/*
 * JS for song73 generated by Appery.io
 */
...
function song73_js() {
     ...
     */
    // On Load
    var song73_onLoad = function() {
        song73_elementsExtraJS();
        song73_deviceEvents();
        song73_windowEvents();
        song73_elementsEvents();
    };
    // screen window events
    function song73_windowEvents() {
        $('#song73').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song73_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song73_elementsExtraJS() {
        // screen (song73) extra code
    };
    // screen elements handler
    function song73_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song73").on("pagebeforeshow", "#song73", function(event, ui) {
        Apperyio.CurrentScreen = "song73";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song73").on("pagecreate", "#song73", function(event, ui) {
