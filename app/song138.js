/*
 * JS for song138 generated by Appery.io
 */
...
function song138_js() {
    ...
    Apperyio.CurrentScreen = 'song138';
     ...
     */
    // On Load
    var song138_onLoad = function() {
        song138_elementsExtraJS();
        song138_deviceEvents();
        song138_windowEvents();
        song138_elementsEvents();
    };
    // screen window events
    function song138_windowEvents() {
        $('#song138').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song138_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song138_elementsExtraJS() {
        // screen (song138) extra code
    };
    // screen elements handler
    function song138_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song138").on("pagebeforeshow", "#song138", function(event, ui) {
        Apperyio.CurrentScreen = "song138";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song138").on("pagecreate", "#song138", function(event, ui) {
