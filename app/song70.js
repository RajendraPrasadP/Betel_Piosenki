/*
 * JS for song70 generated by Appery.io
 */
...
function song70_js() {
     ...
     */
    // On Load
    var song70_onLoad = function() {
        song70_elementsExtraJS();
        song70_deviceEvents();
        song70_windowEvents();
        song70_elementsEvents();
    };
    // screen window events
    function song70_windowEvents() {
        $('#song70').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song70_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song70_elementsExtraJS() {
        // screen (song70) extra code
    };
    // screen elements handler
    function song70_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song70").on("pagebeforeshow", "#song70", function(event, ui) {
        Apperyio.CurrentScreen = "song70";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song70").on("pagecreate", "#song70", function(event, ui) {
