/*
 * JS for song128 generated by Appery.io
 */
...
function song128_js() {
    ...
    Apperyio.CurrentScreen = 'song128';
     ...
     */
    // On Load
    var song128_onLoad = function() {
        song128_elementsExtraJS();
        song128_deviceEvents();
        song128_windowEvents();
        song128_elementsEvents();
    };
    // screen window events
    function song128_windowEvents() {
        $('#song128').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song128_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song128_elementsExtraJS() {
        // screen (song128) extra code
    };
    // screen elements handler
    function song128_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song128").on("pagebeforeshow", "#song128", function(event, ui) {
        Apperyio.CurrentScreen = "song128";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song128").on("pagecreate", "#song128", function(event, ui) {
