/*
 * JS for song85 generated by Appery.io
 */
...
function song85_js() {
     ...
     */
    // On Load
    var song85_onLoad = function() {
        song85_elementsExtraJS();
        song85_deviceEvents();
        song85_windowEvents();
        song85_elementsEvents();
    };
    // screen window events
    function song85_windowEvents() {
        $('#song85').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song85_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song85_elementsExtraJS() {
        // screen (song85) extra code
    };
    // screen elements handler
    function song85_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song85").on("pagebeforeshow", "#song85", function(event, ui) {
        Apperyio.CurrentScreen = "song85";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song85").on("pagecreate", "#song85", function(event, ui) {
