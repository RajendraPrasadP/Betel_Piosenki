/*
 * JS for song57 generated by Appery.io
 */
...
function song57_js() {
     ...
     */
    // On Load
    var song57_onLoad = function() {
        song57_elementsExtraJS();
        song57_deviceEvents();
        song57_windowEvents();
        song57_elementsEvents();
    };
    // screen window events
    function song57_windowEvents() {
        $('#song57').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song57_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song57_elementsExtraJS() {
        // screen (song57) extra code
    };
    // screen elements handler
    function song57_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song57").on("pagebeforeshow", "#song57", function(event, ui) {
        Apperyio.CurrentScreen = "song57";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song57").on("pagecreate", "#song57", function(event, ui) {
