/*
 * JS for song136 generated by Appery.io
 */
...
function song136_js() {
    ...
    Apperyio.CurrentScreen = 'song136';
     ...
     */
    // On Load
    var song136_onLoad = function() {
        song136_elementsExtraJS();
        song136_deviceEvents();
        song136_windowEvents();
        song136_elementsEvents();
    };
    // screen window events
    function song136_windowEvents() {
        $('#song136').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song136_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song136_elementsExtraJS() {
        // screen (song136) extra code
    };
    // screen elements handler
    function song136_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song136").on("pagebeforeshow", "#song136", function(event, ui) {
        Apperyio.CurrentScreen = "song136";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song136").on("pagecreate", "#song136", function(event, ui) {
