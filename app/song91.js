/*
 * JS for song91 generated by Appery.io
 */
...
function song91_js() {
     ...
     */
    // On Load
    var song91_onLoad = function() {
        song91_elementsExtraJS();
        song91_deviceEvents();
        song91_windowEvents();
        song91_elementsEvents();
    };
    // screen window events
    function song91_windowEvents() {
        $('#song91').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song91_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song91_elementsExtraJS() {
        // screen (song91) extra code
    };
    // screen elements handler
    function song91_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song91").on("pagebeforeshow", "#song91", function(event, ui) {
        Apperyio.CurrentScreen = "song91";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song91").on("pagecreate", "#song91", function(event, ui) {
