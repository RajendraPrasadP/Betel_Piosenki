/*
 * JS for song92 generated by Appery.io
 */
...
function song92_js() {
     ...
     */
    // On Load
    var song92_onLoad = function() {
        song92_elementsExtraJS();
        song92_deviceEvents();
        song92_windowEvents();
        song92_elementsEvents();
    };
    // screen window events
    function song92_windowEvents() {
        $('#song92').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song92_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song92_elementsExtraJS() {
        // screen (song92) extra code
    };
    // screen elements handler
    function song92_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song92").on("pagebeforeshow", "#song92", function(event, ui) {
        Apperyio.CurrentScreen = "song92";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song92").on("pagecreate", "#song92", function(event, ui) {
