/*
 * JS for song94 generated by Appery.io
 */
...
function song94_js() {
     ...
     */
    // On Load
    var song94_onLoad = function() {
        song94_elementsExtraJS();
        song94_deviceEvents();
        song94_windowEvents();
        song94_elementsEvents();
    };
    // screen window events
    function song94_windowEvents() {
        $('#song94').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song94_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song94_elementsExtraJS() {
        // screen (song94) extra code
    };
    // screen elements handler
    function song94_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song94").on("pagebeforeshow", "#song94", function(event, ui) {
        Apperyio.CurrentScreen = "song94";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song94").on("pagecreate", "#song94", function(event, ui) {
