/*
 * JS for song40 generated by Appery.io
 */
...
function song40_js() {
     ...
     */
    // On Load
    var song40_onLoad = function() {
        song40_elementsExtraJS();
        song40_deviceEvents();
        song40_windowEvents();
        song40_elementsEvents();
    };
    // screen window events
    function song40_windowEvents() {
        $('#song40').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song40_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song40_elementsExtraJS() {
        // screen (song40) extra code
    };
    // screen elements handler
    function song40_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song40").on("pagebeforeshow", "#song40", function(event, ui) {
        Apperyio.CurrentScreen = "song40";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song40").on("pagecreate", "#song40", function(event, ui) {
