/*
 * JS for song75 generated by Appery.io
 */
...
function song75_js() {
     ...
     */
    // On Load
    var song75_onLoad = function() {
        song75_elementsExtraJS();
        song75_deviceEvents();
        song75_windowEvents();
        song75_elementsEvents();
    };
    // screen window events
    function song75_windowEvents() {
        $('#song75').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song75_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song75_elementsExtraJS() {
        // screen (song75) extra code
    };
    // screen elements handler
    function song75_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song75").on("pagebeforeshow", "#song75", function(event, ui) {
        Apperyio.CurrentScreen = "song75";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song75").on("pagecreate", "#song75", function(event, ui) {
