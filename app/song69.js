/*
 * JS for song69 generated by Appery.io
 */
...
function song69_js() {
     ...
     */
    // On Load
    var song69_onLoad = function() {
        song69_elementsExtraJS();
        song69_deviceEvents();
        song69_windowEvents();
        song69_elementsEvents();
    };
    // screen window events
    function song69_windowEvents() {
        $('#song69').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song69_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song69_elementsExtraJS() {
        // screen (song69) extra code
    };
    // screen elements handler
    function song69_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song69").on("pagebeforeshow", "#song69", function(event, ui) {
        Apperyio.CurrentScreen = "song69";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song69").on("pagecreate", "#song69", function(event, ui) {
