/*
 * JS for song48 generated by Appery.io
 */
...
function song48_js() {
     ...
     */
    // On Load
    var song48_onLoad = function() {
        song48_elementsExtraJS();
        song48_deviceEvents();
        song48_windowEvents();
        song48_elementsEvents();
    };
    // screen window events
    function song48_windowEvents() {
        $('#song48').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song48_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song48_elementsExtraJS() {
        // screen (song48) extra code
    };
    // screen elements handler
    function song48_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song48").on("pagebeforeshow", "#song48", function(event, ui) {
        Apperyio.CurrentScreen = "song48";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song48").on("pagecreate", "#song48", function(event, ui) {
