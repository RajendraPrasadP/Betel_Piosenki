/*
 * JS for song121 generated by Appery.io
 */
...
function song121_js() {
    ...
    Apperyio.CurrentScreen = 'song121';
     ...
     */
    // On Load
    var song121_onLoad = function() {
        song121_elementsExtraJS();
        song121_deviceEvents();
        song121_windowEvents();
        song121_elementsEvents();
    };
    // screen window events
    function song121_windowEvents() {
        $('#song121').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song121_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song121_elementsExtraJS() {
        // screen (song121) extra code
    };
    // screen elements handler
    function song121_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song121").on("pagebeforeshow", "#song121", function(event, ui) {
        Apperyio.CurrentScreen = "song121";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song121").on("pagecreate", "#song121", function(event, ui) {
