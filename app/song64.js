/*
 * JS for song64 generated by Appery.io
 */
...
function song64_js() {
     ...
     */
    // On Load
    var song64_onLoad = function() {
        song64_elementsExtraJS();
        song64_deviceEvents();
        song64_windowEvents();
        song64_elementsEvents();
    };
    // screen window events
    function song64_windowEvents() {
        $('#song64').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song64_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song64_elementsExtraJS() {
        // screen (song64) extra code
    };
    // screen elements handler
    function song64_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song64").on("pagebeforeshow", "#song64", function(event, ui) {
        Apperyio.CurrentScreen = "song64";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song64").on("pagecreate", "#song64", function(event, ui) {
