/*
 * JS for song137 generated by Appery.io
 */
...
function song137_js() {
    ...
    Apperyio.CurrentScreen = 'song137';
     ...
     */
    // On Load
    var song137_onLoad = function() {
        song137_elementsExtraJS();
        song137_deviceEvents();
        song137_windowEvents();
        song137_elementsEvents();
    };
    // screen window events
    function song137_windowEvents() {
        $('#song137').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song137_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song137_elementsExtraJS() {
        // screen (song137) extra code
    };
    // screen elements handler
    function song137_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song137").on("pagebeforeshow", "#song137", function(event, ui) {
        Apperyio.CurrentScreen = "song137";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song137").on("pagecreate", "#song137", function(event, ui) {
