/*
 * JS for song23 generated by Appery.io
 */
...
function song23_js() {
     ...
     */
    // On Load
    var song23_onLoad = function() {
        song23_elementsExtraJS();
        song23_deviceEvents();
        song23_windowEvents();
        song23_elementsEvents();
    };
    // screen window events
    function song23_windowEvents() {
        $('#song23').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song23_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song23_elementsExtraJS() {
        // screen (song23) extra code
    };
    // screen elements handler
    function song23_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song23").on("pagebeforeshow", "#song23", function(event, ui) {
        Apperyio.CurrentScreen = "song23";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song23").on("pagecreate", "#song23", function(event, ui) {
