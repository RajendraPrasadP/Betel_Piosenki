/*
 * JS for song123 generated by Appery.io
 */
...
function song123_js() {
    ...
    Apperyio.CurrentScreen = 'song123';
     ...
     */
    // On Load
    var song123_onLoad = function() {
        song123_elementsExtraJS();
        song123_deviceEvents();
        song123_windowEvents();
        song123_elementsEvents();
    };
    // screen window events
    function song123_windowEvents() {
        $('#song123').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song123_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song123_elementsExtraJS() {
        // screen (song123) extra code
    };
    // screen elements handler
    function song123_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song123").on("pagebeforeshow", "#song123", function(event, ui) {
        Apperyio.CurrentScreen = "song123";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song123").on("pagecreate", "#song123", function(event, ui) {
