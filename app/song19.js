/*
 * JS for song19 generated by Appery.io
 */
...
function song19_js() {
     ...
     */
    // On Load
    var song19_onLoad = function() {
        song19_elementsExtraJS();
        song19_deviceEvents();
        song19_windowEvents();
        song19_elementsEvents();
    };
    // screen window events
    function song19_windowEvents() {
        $('#song19').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song19_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song19_elementsExtraJS() {
        // screen (song19) extra code
    };
    // screen elements handler
    function song19_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song19").on("pagebeforeshow", "#song19", function(event, ui) {
        Apperyio.CurrentScreen = "song19";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song19").on("pagecreate", "#song19", function(event, ui) {
