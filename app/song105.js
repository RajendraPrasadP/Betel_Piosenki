/*
 * JS for song105 generated by Appery.io
 */
...
function song105_js() {
    ...
    Apperyio.CurrentScreen = 'song105';
     ...
     */
    // On Load
    var song105_onLoad = function() {
        song105_elementsExtraJS();
        song105_deviceEvents();
        song105_windowEvents();
        song105_elementsEvents();
    };
    // screen window events
    function song105_windowEvents() {
        $('#song105').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song105_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song105_elementsExtraJS() {
        // screen (song105) extra code
    };
    // screen elements handler
    function song105_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song105").on("pagebeforeshow", "#song105", function(event, ui) {
        Apperyio.CurrentScreen = "song105";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song105").on("pagecreate", "#song105", function(event, ui) {
