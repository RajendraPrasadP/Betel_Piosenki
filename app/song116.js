/*
 * JS for song116 generated by Appery.io
 */
...
function song116_js() {
    ...
    Apperyio.CurrentScreen = 'song116';
     ...
     */
    // On Load
    var song116_onLoad = function() {
        song116_elementsExtraJS();
        song116_deviceEvents();
        song116_windowEvents();
        song116_elementsEvents();
    };
    // screen window events
    function song116_windowEvents() {
        $('#song116').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song116_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song116_elementsExtraJS() {
        // screen (song116) extra code
    };
    // screen elements handler
    function song116_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song116").on("pagebeforeshow", "#song116", function(event, ui) {
        Apperyio.CurrentScreen = "song116";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song116").on("pagecreate", "#song116", function(event, ui) {
