/*
 * JS for song117 generated by Appery.io
 */
...
function song117_js() {
    ...
    Apperyio.CurrentScreen = 'song117';
     ...
     */
    // On Load
    var song117_onLoad = function() {
        song117_elementsExtraJS();
        song117_deviceEvents();
        song117_windowEvents();
        song117_elementsEvents();
    };
    // screen window events
    function song117_windowEvents() {
        $('#song117').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song117_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song117_elementsExtraJS() {
        // screen (song117) extra code
    };
    // screen elements handler
    function song117_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song117").on("pagebeforeshow", "#song117", function(event, ui) {
        Apperyio.CurrentScreen = "song117";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song117").on("pagecreate", "#song117", function(event, ui) {
