/*
 * JS for song18 generated by Appery.io
 */
...
function song18_js() {
     ...
     */
    // On Load
    var song18_onLoad = function() {
        song18_elementsExtraJS();
        song18_deviceEvents();
        song18_windowEvents();
        song18_elementsEvents();
    };
    // screen window events
    function song18_windowEvents() {
        $('#song18').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song18_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song18_elementsExtraJS() {
        // screen (song18) extra code
    };
    // screen elements handler
    function song18_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song18").on("pagebeforeshow", "#song18", function(event, ui) {
        Apperyio.CurrentScreen = "song18";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song18").on("pagecreate", "#song18", function(event, ui) {
