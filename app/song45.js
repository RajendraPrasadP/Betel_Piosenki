/*
 * JS for song45 generated by Appery.io
 */
...
function song45_js() {
     ...
     */
    // On Load
    var song45_onLoad = function() {
        song45_elementsExtraJS();
        song45_deviceEvents();
        song45_windowEvents();
        song45_elementsEvents();
    };
    // screen window events
    function song45_windowEvents() {
        $('#song45').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song45_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song45_elementsExtraJS() {
        // screen (song45) extra code
    };
    // screen elements handler
    function song45_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song45").on("pagebeforeshow", "#song45", function(event, ui) {
        Apperyio.CurrentScreen = "song45";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song45").on("pagecreate", "#song45", function(event, ui) {
