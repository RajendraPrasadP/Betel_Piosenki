/*
 * JS for song25 generated by Appery.io
 */
...
function song25_js() {
     ...
     */
    // On Load
    var song25_onLoad = function() {
        song25_elementsExtraJS();
        song25_deviceEvents();
        song25_windowEvents();
        song25_elementsEvents();
    };
    // screen window events
    function song25_windowEvents() {
        $('#song25').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song25_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song25_elementsExtraJS() {
        // screen (song25) extra code
    };
    // screen elements handler
    function song25_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song25").on("pagebeforeshow", "#song25", function(event, ui) {
        Apperyio.CurrentScreen = "song25";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song25").on("pagecreate", "#song25", function(event, ui) {
