/*
 * JS for song26 generated by Appery.io
 */
...
function song26_js() {
     ...
     */
    // On Load
    var song26_onLoad = function() {
        song26_elementsExtraJS();
        song26_deviceEvents();
        song26_windowEvents();
        song26_elementsEvents();
    };
    // screen window events
    function song26_windowEvents() {
        $('#song26').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song26_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song26_elementsExtraJS() {
        // screen (song26) extra code
    };
    // screen elements handler
    function song26_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song26").on("pagebeforeshow", "#song26", function(event, ui) {
        Apperyio.CurrentScreen = "song26";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song26").on("pagecreate", "#song26", function(event, ui) {
