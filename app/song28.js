/*
 * JS for song28 generated by Appery.io
 */
...
function song28_js() {
     ...
     */
    // On Load
    var song28_onLoad = function() {
        song28_elementsExtraJS();
        song28_deviceEvents();
        song28_windowEvents();
        song28_elementsEvents();
    };
    // screen window events
    function song28_windowEvents() {
        $('#song28').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song28_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song28_elementsExtraJS() {
        // screen (song28) extra code
    };
    // screen elements handler
    function song28_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song28").on("pagebeforeshow", "#song28", function(event, ui) {
        Apperyio.CurrentScreen = "song28";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song28").on("pagecreate", "#song28", function(event, ui) {
