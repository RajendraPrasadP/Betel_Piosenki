/*
 * JS for song35 generated by Appery.io
 */
...
function song35_js() {
     ...
     */
    // On Load
    var song35_onLoad = function() {
        song35_elementsExtraJS();
        song35_deviceEvents();
        song35_windowEvents();
        song35_elementsEvents();
    };
    // screen window events
    function song35_windowEvents() {
        $('#song35').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song35_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song35_elementsExtraJS() {
        // screen (song35) extra code
    };
    // screen elements handler
    function song35_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song35").on("pagebeforeshow", "#song35", function(event, ui) {
        Apperyio.CurrentScreen = "song35";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song35").on("pagecreate", "#song35", function(event, ui) {
