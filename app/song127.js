/*
 * JS for song127 generated by Appery.io
 */
...
function song127_js() {
    ...
    Apperyio.CurrentScreen = 'song127';
     ...
     */
    // On Load
    var song127_onLoad = function() {
        song127_elementsExtraJS();
        song127_deviceEvents();
        song127_windowEvents();
        song127_elementsEvents();
    };
    // screen window events
    function song127_windowEvents() {
        $('#song127').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song127_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song127_elementsExtraJS() {
        // screen (song127) extra code
    };
    // screen elements handler
    function song127_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song127").on("pagebeforeshow", "#song127", function(event, ui) {
        Apperyio.CurrentScreen = "song127";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song127").on("pagecreate", "#song127", function(event, ui) {
