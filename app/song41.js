/*
 * JS for song41 generated by Appery.io
 */
...
function song41_js() {
     ...
     */
    // On Load
    var song41_onLoad = function() {
        song41_elementsExtraJS();
        song41_deviceEvents();
        song41_windowEvents();
        song41_elementsEvents();
    };
    // screen window events
    function song41_windowEvents() {
        $('#song41').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song41_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song41_elementsExtraJS() {
        // screen (song41) extra code
    };
    // screen elements handler
    function song41_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song41").on("pagebeforeshow", "#song41", function(event, ui) {
        Apperyio.CurrentScreen = "song41";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song41").on("pagecreate", "#song41", function(event, ui) {
