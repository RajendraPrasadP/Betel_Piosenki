/*
 * JS for song98 generated by Appery.io
 */
...
function song98_js() {
     ...
     */
    // On Load
    var song98_onLoad = function() {
        song98_elementsExtraJS();
        song98_deviceEvents();
        song98_windowEvents();
        song98_elementsEvents();
    };
    // screen window events
    function song98_windowEvents() {
        $('#song98').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song98_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song98_elementsExtraJS() {
        // screen (song98) extra code
    };
    // screen elements handler
    function song98_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song98").on("pagebeforeshow", "#song98", function(event, ui) {
        Apperyio.CurrentScreen = "song98";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song98").on("pagecreate", "#song98", function(event, ui) {
