/*
 * JS for song12 generated by Appery.io
 */
...
function song12_js() {
     ...
     */
    // On Load
    var song12_onLoad = function() {
        song12_elementsExtraJS();
        song12_deviceEvents();
        song12_windowEvents();
        song12_elementsEvents();
    };
    // screen window events
    function song12_windowEvents() {
        $('#song12').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song12_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song12_elementsExtraJS() {
        // screen (song12) extra code
    };
    // screen elements handler
    function song12_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song12").on("pagebeforeshow", "#song12", function(event, ui) {
        Apperyio.CurrentScreen = "song12";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song12").on("pagecreate", "#song12", function(event, ui) {
