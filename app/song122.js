/*
 * JS for song122 generated by Appery.io
 */
...
function song122_js() {
    ...
    Apperyio.CurrentScreen = 'song122';
     ...
     */
    // On Load
    var song122_onLoad = function() {
        song122_elementsExtraJS();
        song122_deviceEvents();
        song122_windowEvents();
        song122_elementsEvents();
    };
    // screen window events
    function song122_windowEvents() {
        $('#song122').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song122_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song122_elementsExtraJS() {
        // screen (song122) extra code
    };
    // screen elements handler
    function song122_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song122").on("pagebeforeshow", "#song122", function(event, ui) {
        Apperyio.CurrentScreen = "song122";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song122").on("pagecreate", "#song122", function(event, ui) {
