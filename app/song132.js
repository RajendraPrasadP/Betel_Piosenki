/*
 * JS for song132 generated by Appery.io
 */
...
function song132_js() {
    ...
    Apperyio.CurrentScreen = 'song132';
     ...
     */
    // On Load
    var song132_onLoad = function() {
        song132_elementsExtraJS();
        song132_deviceEvents();
        song132_windowEvents();
        song132_elementsEvents();
    };
    // screen window events
    function song132_windowEvents() {
        $('#song132').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song132_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song132_elementsExtraJS() {
        // screen (song132) extra code
    };
    // screen elements handler
    function song132_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song132").on("pagebeforeshow", "#song132", function(event, ui) {
        Apperyio.CurrentScreen = "song132";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song132").on("pagecreate", "#song132", function(event, ui) {
