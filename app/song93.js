/*
 * JS for song93 generated by Appery.io
 */
...
function song93_js() {
     ...
     */
    // On Load
    var song93_onLoad = function() {
        song93_elementsExtraJS();
        song93_deviceEvents();
        song93_windowEvents();
        song93_elementsEvents();
    };
    // screen window events
    function song93_windowEvents() {
        $('#song93').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song93_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song93_elementsExtraJS() {
        // screen (song93) extra code
    };
    // screen elements handler
    function song93_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song93").on("pagebeforeshow", "#song93", function(event, ui) {
        Apperyio.CurrentScreen = "song93";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song93").on("pagecreate", "#song93", function(event, ui) {
