/*
 * JS for song133 generated by Appery.io
 */
...
function song133_js() {
    ...
    Apperyio.CurrentScreen = 'song133';
     ...
     */
    // On Load
    var song133_onLoad = function() {
        song133_elementsExtraJS();
        song133_deviceEvents();
        song133_windowEvents();
        song133_elementsEvents();
    };
    // screen window events
    function song133_windowEvents() {
        $('#song133').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song133_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song133_elementsExtraJS() {
        // screen (song133) extra code
    };
    // screen elements handler
    function song133_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song133").on("pagebeforeshow", "#song133", function(event, ui) {
        Apperyio.CurrentScreen = "song133";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song133").on("pagecreate", "#song133", function(event, ui) {
