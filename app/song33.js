/*
 * JS for song33 generated by Appery.io
 */
...
function song33_js() {
     ...
     */
    // On Load
    var song33_onLoad = function() {
        song33_elementsExtraJS();
        song33_deviceEvents();
        song33_windowEvents();
        song33_elementsEvents();
    };
    // screen window events
    function song33_windowEvents() {
        $('#song33').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song33_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song33_elementsExtraJS() {
        // screen (song33) extra code
    };
    // screen elements handler
    function song33_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song33").on("pagebeforeshow", "#song33", function(event, ui) {
        Apperyio.CurrentScreen = "song33";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song33").on("pagecreate", "#song33", function(event, ui) {
