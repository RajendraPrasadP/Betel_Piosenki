/*
 * JS for song103 generated by Appery.io
 */
...
function song103_js() {
    ...
    Apperyio.CurrentScreen = 'song103';
     ...
     */
    // On Load
    var song103_onLoad = function() {
        song103_elementsExtraJS();
        song103_deviceEvents();
        song103_windowEvents();
        song103_elementsEvents();
    };
    // screen window events
    function song103_windowEvents() {
        $('#song103').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song103_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song103_elementsExtraJS() {
        // screen (song103) extra code
    };
    // screen elements handler
    function song103_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song103").on("pagebeforeshow", "#song103", function(event, ui) {
        Apperyio.CurrentScreen = "song103";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song103").on("pagecreate", "#song103", function(event, ui) {
