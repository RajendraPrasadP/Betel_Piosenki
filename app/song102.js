/*
 * JS for song102 generated by Appery.io
 */
...
function song102_js() {
    ...
    Apperyio.CurrentScreen = 'song102';
     ...
     */
    // On Load
    var song102_onLoad = function() {
        song102_elementsExtraJS();
        song102_deviceEvents();
        song102_windowEvents();
        song102_elementsEvents();
    };
    // screen window events
    function song102_windowEvents() {
        $('#song102').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song102_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song102_elementsExtraJS() {
        // screen (song102) extra code
    };
    // screen elements handler
    function song102_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song102").on("pagebeforeshow", "#song102", function(event, ui) {
        Apperyio.CurrentScreen = "song102";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song102").on("pagecreate", "#song102", function(event, ui) {
