/*
 * JS for song124 generated by Appery.io
 */
...
function song124_js() {
    ...
    Apperyio.CurrentScreen = 'song124';
     ...
     */
    // On Load
    var song124_onLoad = function() {
        song124_elementsExtraJS();
        song124_deviceEvents();
        song124_windowEvents();
        song124_elementsEvents();
    };
    // screen window events
    function song124_windowEvents() {
        $('#song124').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song124_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song124_elementsExtraJS() {
        // screen (song124) extra code
    };
    // screen elements handler
    function song124_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song124").on("pagebeforeshow", "#song124", function(event, ui) {
        Apperyio.CurrentScreen = "song124";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song124").on("pagecreate", "#song124", function(event, ui) {
