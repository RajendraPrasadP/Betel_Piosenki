/*
 * JS for song107 generated by Appery.io
 */
...
function song107_js() {
    ...
    Apperyio.CurrentScreen = 'song107';
     ...
     */
    // On Load
    var song107_onLoad = function() {
        song107_elementsExtraJS();
        song107_deviceEvents();
        song107_windowEvents();
        song107_elementsEvents();
    };
    // screen window events
    function song107_windowEvents() {
        $('#song107').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song107_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song107_elementsExtraJS() {
        // screen (song107) extra code
    };
    // screen elements handler
    function song107_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song107").on("pagebeforeshow", "#song107", function(event, ui) {
        Apperyio.CurrentScreen = "song107";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song107").on("pagecreate", "#song107", function(event, ui) {
