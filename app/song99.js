/*
 * JS for song99 generated by Appery.io
 */
...
function song99_js() {
     ...
     */
    // On Load
    var song99_onLoad = function() {
        song99_elementsExtraJS();
        song99_deviceEvents();
        song99_windowEvents();
        song99_elementsEvents();
    };
    // screen window events
    function song99_windowEvents() {
        $('#song99').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song99_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song99_elementsExtraJS() {
        // screen (song99) extra code
    };
    // screen elements handler
    function song99_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song99").on("pagebeforeshow", "#song99", function(event, ui) {
        Apperyio.CurrentScreen = "song99";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song99").on("pagecreate", "#song99", function(event, ui) {
