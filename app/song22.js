/*
 * JS for song22 generated by Appery.io
 */
...
function song22_js() {
     ...
     */
    // On Load
    var song22_onLoad = function() {
        song22_elementsExtraJS();
        song22_deviceEvents();
        song22_windowEvents();
        song22_elementsEvents();
    };
    // screen window events
    function song22_windowEvents() {
        $('#song22').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song22_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song22_elementsExtraJS() {
        // screen (song22) extra code
    };
    // screen elements handler
    function song22_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song22").on("pagebeforeshow", "#song22", function(event, ui) {
        Apperyio.CurrentScreen = "song22";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song22").on("pagecreate", "#song22", function(event, ui) {
