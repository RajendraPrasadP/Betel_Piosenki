/*
 * JS for song65 generated by Appery.io
 */
...
function song65_js() {
     ...
     */
    // On Load
    var song65_onLoad = function() {
        song65_elementsExtraJS();
        song65_deviceEvents();
        song65_windowEvents();
        song65_elementsEvents();
    };
    // screen window events
    function song65_windowEvents() {
        $('#song65').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song65_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song65_elementsExtraJS() {
        // screen (song65) extra code
    };
    // screen elements handler
    function song65_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song65").on("pagebeforeshow", "#song65", function(event, ui) {
        Apperyio.CurrentScreen = "song65";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song65").on("pagecreate", "#song65", function(event, ui) {
