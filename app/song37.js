/*
 * JS for song37 generated by Appery.io
 */
...
function song37_js() {
     ...
     */
    // On Load
    var song37_onLoad = function() {
        song37_elementsExtraJS();
        song37_deviceEvents();
        song37_windowEvents();
        song37_elementsEvents();
    };
    // screen window events
    function song37_windowEvents() {
        $('#song37').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song37_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song37_elementsExtraJS() {
        // screen (song37) extra code
    };
    // screen elements handler
    function song37_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song37").on("pagebeforeshow", "#song37", function(event, ui) {
        Apperyio.CurrentScreen = "song37";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song37").on("pagecreate", "#song37", function(event, ui) {
