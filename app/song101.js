/*
 * JS for song101 generated by Appery.io
 */
...
function song101_js() {
    ...
    Apperyio.CurrentScreen = 'song101';
     ...
     */
    // On Load
    var song101_onLoad = function() {
        song101_elementsExtraJS();
        song101_deviceEvents();
        song101_windowEvents();
        song101_elementsEvents();
    };
    // screen window events
    function song101_windowEvents() {
        $('#song101').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song101_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song101_elementsExtraJS() {
        // screen (song101) extra code
    };
    // screen elements handler
    function song101_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song101").on("pagebeforeshow", "#song101", function(event, ui) {
        Apperyio.CurrentScreen = "song101";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song101").on("pagecreate", "#song101", function(event, ui) {
