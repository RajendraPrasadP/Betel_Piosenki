/*
 * JS for song88 generated by Appery.io
 */
...
function song88_js() {
     ...
     */
    // On Load
    var song88_onLoad = function() {
        song88_elementsExtraJS();
        song88_deviceEvents();
        song88_windowEvents();
        song88_elementsEvents();
    };
    // screen window events
    function song88_windowEvents() {
        $('#song88').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song88_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song88_elementsExtraJS() {
        // screen (song88) extra code
    };
    // screen elements handler
    function song88_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song88").on("pagebeforeshow", "#song88", function(event, ui) {
        Apperyio.CurrentScreen = "song88";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song88").on("pagecreate", "#song88", function(event, ui) {
