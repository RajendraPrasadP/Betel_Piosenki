/*
 * JS for song135 generated by Appery.io
 */
...
function song135_js() {
    ...
    Apperyio.CurrentScreen = 'song135';
     ...
     */
    // On Load
    var song135_onLoad = function() {
        song135_elementsExtraJS();
        song135_deviceEvents();
        song135_windowEvents();
        song135_elementsEvents();
    };
    // screen window events
    function song135_windowEvents() {
        $('#song135').bind('pageshow orientationchange', function() {
            var _page = this;
            adjustContentHeightWithPadding(_page);
        });
    };
    // device events
    function song135_deviceEvents() {
        document.addEventListener("deviceready", function() {
        });
    };
    // screen elements extra js
    function song135_elementsExtraJS() {
        // screen (song135) extra code
    };
    // screen elements handler
    function song135_elementsEvents() {
        $(document).on("click", "a :input,a a,a fieldset label", function(event) {
            event.stopPropagation();
        });
    };
    $(document).off("pagebeforeshow", "#song135").on("pagebeforeshow", "#song135", function(event, ui) {
        Apperyio.CurrentScreen = "song135";
        _.chain(Apperyio.mappings)
            .filter(function(m) {
                return m.homeScreen === Apperyio.CurrentScreen;
...
$(document).off("pagecreate", "#song135").on("pagecreate", "#song135", function(event, ui) {
